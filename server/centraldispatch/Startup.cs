...
namespace centraldispatch
{
  public class Startup
  {
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env)
    {
      ...
      app.Map("/get", (appBuilder) =>
      {
        appBuilder.Run(async (context) =>
        {
          var pickCity = context.Request.Query["pickCity"];
          var pickState = context.Request.Query["pickState"];
          var destCity = context.Request.Query["destCity"];
          var destState = context.Request.Query["destState"];
          ...
          if (string.IsNullOrWhiteSpace(pickCity) || string.IsNullOrWhiteSpace(pickState) || string.IsNullOrWhiteSpace(destCity) || string.IsNullOrWhiteSpace(destState)) {
            await context.Response.WriteAsync("Some or all search parameters are not specified");
