  ...
  public class Startup
  {
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env)
    {
      ...
      app.Map("/get", (appBuilder) =>
      {
        ...
        {
          var pickCity = context.Request.Query["pickCity"].ToString();
          var pickState = context.Request.Query["pickState"].ToString();
          var destCity = context.Request.Query["destCity"].ToString();
          var destState = context.Request.Query["destState"].ToString();
          var token = context.Request.Query["token"].ToString();
          var sessid = context.Request.Query["sessid"].ToString();
          ...
          if (string.IsNullOrWhiteSpace(pickCity) || string.IsNullOrWhiteSpace(pickState) || string.IsNullOrWhiteSpace(destCity) || string.IsNullOrWhiteSpace(destState)
            || string.IsNullOrWhiteSpace(token) || string.IsNullOrWhiteSpace(sessid))
          {
